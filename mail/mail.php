...
$outgoingServerAddress      = 'smtp.1and1.com'; // Consult your hosting provider.
...
$sendingAccountUsername     = 'contacto@psimbiosis.com';
$sendingAccountPassword     = 'Psimbiosis123';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'antonio@psimbiosis.com'; // REQUIRED value.
$recipientName              = 'Equipo Psimbiosis';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'Un nuevo mensaje desde la web'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Psimbiosis Web';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'America/Bogota';         // OPTIONAL, but some servers require this to be set. 
